...
import { 
  getFirestore, collection, addDoc, doc, updateDoc, increment, getDocs, query, where, orderBy, limit, deleteDoc 
...
export { 
  db, auth, collection, addDoc, doc, updateDoc, increment, getDocs, query, where, orderBy, limit, deleteDoc,
